...
console.log(g)
EOS
      expect(js).to eq "g={365:\"decimal\",255:\"hex\",3.14:\"float\",1e10:\"exp\",123456789012345680000:\"big e<=21\",1.2345678901234568e+21:\"big e>=21\",123.45678901234568:\"e=0\",0.0000012345678901234567:\"e>=-6\",1.2345678901234568e-10:\"e<=-6\",Infinity:\"+Inf\",0:\"-Inf\"};console.log(g);"
